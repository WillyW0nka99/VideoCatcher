...
<ul dir="rtl">
  ...
  <li>נעילה לחלונית אחת והצגה ברורה של החלונית וה־URL שאליהם התוסף משויך</li>
  <li>בדיקה אוטומטית של גרסה חדשה ב־GitHub וקישור ישיר ל־Release העדכני</li>
...
<p dir="rtl"><strong>שימו לב:</strong> נכון לגרסה הנוכחית, הרשאות האתרים של התוסף מוגבלות ל־<code dir="ltr">*.ac.il</code> ולשרתי המדיה הנדרשים לצורך ההורדה. בנוסף קיימת גישה ל־<code dir="ltr">api.github.com</code> לצורך בדיקת גרסת ה־Release האחרונה בלבד.</p>
...
<p dir="rtl">Video Catcher נשאר נעול לחלונית שבה הוא נפתח או שאליה הועבר באמצעות כפתור הרענון ↻. מעבר לחלוניות אחרות ב־Chrome אינו משנה את החלונית שהתוסף סורק ואינו מאפס הורדה פעילה. רק לחיצה על ↻ מאמצת את החלונית הפעילה באותו רגע והופכת אותה לחלונית הנעולה החדשה. הכפתור <strong>סריקה מחדש</strong> סורק שוב את החלונית שכבר נעולה ואינו מחליף חלונית.</p>

<p dir="rtl">אם לוחצים על ↻ כאשר החלונית הפעילה נמצאת באתר שאינו נתמך, התוסף מציג <strong>אתר זה לא נתמך</strong> ואינו מנסה לבצע סריקת מדיה.</p>
...
<h2 dir="rtl">בדיקת עדכונים</h2>

<p dir="rtl">Video Catcher בודק מעת לעת מהו ה־<span dir="ltr">Latest Release</span> ב־GitHub. הבדיקה נשמרת במטמון ומתבצעת לכל היותר פעם בכ־30 דקות.</p>

<p dir="rtl">כאשר קיימת גרסה חדשה יותר מהגרסה המותקנת, מופיעה ליד מספר הגרסה בתחתית החלונית הודעה אדומה: <strong>קיימת גרסה חדשה — לחץ להורדה</strong>. לחיצה על ההודעה פותחת את עמוד ה־Release החדש ב־GitHub. ההתקנה עצמה עדיין מתבצעת ידנית משום שהתוסף נטען באמצעות <span dir="ltr">Load unpacked</span>.</p>
...
<p dir="rtl"><strong>גרסה נוכחית:</strong> <code dir="ltr">v0.7.3</code></p>